...
class IOSAdapter extends adapterCollection_1.AdapterCollection {
    constructor(id, socket, proxySettings, frontEndUrl) {
        super(id, socket, {
            ...
            devices.forEach((d) => {
                ...
                if (!this._adapters.has(adapterId)) {
                    ...
                    if (parts.length > 1) {
                        ...
                        const adapter = new adapter_1.Adapter(adapterId, this._proxyUrl, {
                            port: port,
    ...
    connectTo(url, wsFrom) {
        ...
        if (!this._protocolMap.has(target)) {
            const version = ((_a = target.data) === null || _a === void 0 ? void 0 : _a.metadata).version;
    ...
    static getProxySettings(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            settings = Object.assign(Object.assign({}, args), { proxyPath: proxyPath, proxyPort: proxyPort, proxyArgs: proxyArgs });
            return settings;
        });
    }
    static getProxyPath() {
        ...
        return new Promise((resolve, reject) => {
            if (os.platform() === "win32") {
                const proxy = process.env.SCOOP
                    ? path.resolve(__dirname, process.env.SCOOP +
                        "/apps/ios-webkit-debug-proxy/current/ios_webkit_debug_proxy.exe")
                    : path.resolve(__dirname, process.env.USERPROFILE +
